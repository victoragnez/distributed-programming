...
public class TestGenerator {
	...
	public static Collection<Object[]> getTests(){
		...
		adiciona(a, "Insertion", true, true, false);
		adiciona(a, "Merge", true, true, true);
		adiciona(a, "Selection", true, true, false);
		adiciona(a, "Random", true, false, false);
		adiciona(a, "Bubble", true, true, false);
		adiciona(a, "Heap", true, true, true);
		adiciona(a, "Quick", true, true, true);
		adiciona(a, "Radix", true, true, true);
		adiciona(a, "Counting", false, true, false);
		adiciona(a, "BinaryTree", true, true, true);
		adiciona(a, "Stooge", true, true, false);
		return a;
	}

	private static void adiciona(ArrayList<Object[]> a, String s, boolean bigElements, boolean bigArray, boolean giantTest) {
